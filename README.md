...
In the Runner.py file, paste in the two links and specify two CSV files to output the results to. For the way it is currently set up, the results will be contained in the rankings.csv file and the component scores.csv file. When everything is set, run the Runner.py script.
